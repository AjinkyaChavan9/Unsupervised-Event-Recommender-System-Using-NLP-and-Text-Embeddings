...
Original file is located at
    https://colab.research.google.com/drive/1VDQBnZsI-XOw0JXEpxrZhlizX4pNbnAw
"""

'''
Dependencies: pandas, numpy, nltk, wordtodigits, tensorflow, tensorflow_hub, inflect, scikit-learn
Installing can be done by running the following commands in command prompt/terminal        
    pip install pandas
    pip install numpy
    pip install nltk
